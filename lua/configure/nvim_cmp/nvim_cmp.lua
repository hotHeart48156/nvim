...
plugin.core.config = function()
    ...
    -- vim.cmd("autocmd FileType dap-repl lua require('cmp').setup.buffer { enabled = false }")
    -- vim.cmd("autocmd FileType dapui_watches lua require('cmp').setup.buffer { enabled = false }")
